...
// NewCoreStatsResetParams creates a new CoreStatsResetParams object
// with the default values initialized.
func NewCoreStatsResetParams() *CoreStatsResetParams {
	var ()
	return &CoreStatsResetParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCoreStatsResetParamsWithTimeout creates a new CoreStatsResetParams object
...
// NewCoreStatsResetParamsWithContext creates a new CoreStatsResetParams object
...
// NewCoreStatsResetParamsWithHTTPClient creates a new CoreStatsResetParams object
...
func (o *CoreStatsResetParams) WithContext(ctx context.Context) *CoreStatsResetParams {
	o.SetContext(ctx)
	return o
}
